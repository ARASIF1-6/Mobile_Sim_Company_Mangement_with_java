...
public class Start
{
	public static void main(String args[])
	{
		...
		MobileSimCompany  msc = new MobileSimCompany ("Grameen-Phone", "Uttara");
		
		System.out.println("------------------------------------");
		System.out.println("Welcome to Grameen-Phone");
		System.out.println("------------------------------------\n");
		...
		while(repeat)
		{
			...
			switch(choice)
			{
				case 1:
					...
					switch(option1)
					{
						...
						case 2:
							...
							System.out.print("Enter the Employee ID to remove an Employee: ");
				...
				case 2:
					...
					System.out.println("#####################################");
					System.out.println("You have selected Sim Management");
					System.out.println("#####################################");
